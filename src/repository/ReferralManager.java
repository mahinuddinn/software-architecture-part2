...
public class ReferralManager {
    ...
    /**
 * Generates referral email-style content (simulation only).
 * No real email is sent.
 */
public String generateReferralEmailContent(Referral referral) {

    StringBuilder sb = new StringBuilder();

    sb.append("--------------------------------------------------\n");
    sb.append("HEALTHCARE REFERRAL NOTIFICATION\n");
    sb.append("--------------------------------------------------\n");
    sb.append("Referral ID: ").append(referral.getReferralId()).append("\n");
    sb.append("Patient ID: ").append(referral.getPatientId()).append("\n");
    sb.append("Referring Clinician: ").append(referral.getReferringClinicianId()).append("\n");
    sb.append("Referred To Clinician: ").append(referral.getReferredToClinicianId()).append("\n");
    sb.append("From Facility: ").append(referral.getReferringFacilityId()).append("\n");
    sb.append("To Facility: ").append(referral.getReferredToFacilityId()).append("\n");
    ...
    sb.append(referral.getReferralReason()).append("\n\n");

    sb.append("Clinical Summary:\n");
    sb.append(referral.getClinicalSummary()).append("\n\n");

    sb.append("Requested Investigations:\n");
    sb.append(referral.getRequestedInvestigations()).append("\n\n");

    sb.append("Notes:\n");
    sb.append(referral.getNotes()).append("\n\n");

    sb.append("Generated by Healthcare Referral System\n");
    sb.append("--------------------------------------------------\n\n");
